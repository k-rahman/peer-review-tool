...
{
	public class SubmissionStartedEventHandler : IConsumer<SubmissionStarted>
	{
		private readonly IMapper _mapper;
		private readonly ManagementApiClient _managementApiClient;
		private readonly IMessagingService _messagingService;
		public SubmissionStartedEventHandler(IMapper mapper, ManagementApiClient managementApiClient, IMessagingService messagingService)
		{
			_mapper = mapper;
		...
		public async Task Consume(ConsumeContext<SubmissionStarted> context)
		{
			...
			foreach (var participant in participants)
			{
				...
				if (verified)
				{
					var emailSubject = "Submission phase started on peer review";
				...
				{
					var emailSubject = "Reset password and submission phase started on peer review";
